...
にぃ = nyi      にぇ = nye      にゃ = nya      にゅ = nyu      にょ = nyo  
...
さ サ sa し シ sishi す ス su せ セ se そ ソ so
...
ざ ザ za じ ジ ziji ず ズ zu ぜ ゼ ze ぞ ゾ zo
だ ダ da ぢ ヂ jidi づ ヅ zudu で デ de ど ド do
ば バ ba び ビ bi ぶ ブ bu べ ベ be ぼ ボ bo
ぱ パ pa ぴ ピ pi ぷ プ pu ぺ ペ pe ぽ ポ po
ゃ ャ lya ゅ ュ lyu ょ ョ lyo ー yy
'''
...
def hira_kake_dict():
    ...
    for e in equations:
        new_text += e[:3] + "\n"
    with open('hira_kake.data', 'wb+') as f:
        f.write(new_text[:-1].encode('utf8'))
